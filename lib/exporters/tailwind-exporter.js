    ...
    extend: {
      colors: {
        ...
        chart: {
          ...
          'legend-text': 'var(--chart-legend-text)',
          title: 'var(--chart-title)',
          subtitle: 'var(--chart-subtitle)',
        },
`;
  ...
  theme: {
    extend: {
      colors: {
        ...
        // Chart colors
        chart: {
          1: '${formatColor(lightColors.chart1)}',
          2: '${formatColor(lightColors.chart2)}',
          3: '${formatColor(lightColors.chart3)}',
          4: '${formatColor(lightColors.chart4)}',
          5: '${formatColor(lightColors.chart5)}',
          grid: '${formatColor(lightColors.chartGrid)}',
          axis: '${formatColor(lightColors.chartAxis)}',
          'axis-label': '${formatColor(lightColors.chartAxisLabel)}',
          'tooltip-bg': '${formatColor(lightColors.chartTooltipBg)}',
          'tooltip-border': '${formatColor(lightColors.chartTooltipBorder)}',
          'tooltip-text': '${formatColor(lightColors.chartTooltipText)}',
          'legend-text': '${formatColor(lightColors.chartLegendText)}',
          title: '${formatColor(lightColors.chartTitle)}',
          subtitle: '${formatColor(lightColors.chartSubtitle)}',
        },
      },
    },
  },
